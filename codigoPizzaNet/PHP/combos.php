...
<table class="table table-striped">
  ...
  <img src="https://i.ibb.co/PMNDwt0/combopersonal.png" class="mr-3" alt="..." width="250em" height="150em">
  <div class="media-body">
    <h5 class="mt-0">Combo Personal</h5>
    Pizza de tamaño personal, del sabor que prefiera el cliente. Se incluye gaseosa de tamaño personal del sabor de preferencia del cliente.
  </div>

  <?php
          if(isset($_SESSION['user'])){
            echo "<a href='infocombo1.php' class='btn btn-danger'>";
  ...
  <path fill-rule="evenodd" d="M4 8a.5.5 0 0 0 .5.5h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H4.5A.5.5 0 0 0 4 8z"/>
    ...
    <th>
      	<div class="media text-dark">
  <img src="https://i.ibb.co/YXZRdrm/combopareja.jpg" class="mr-3" alt="..." width="250em" height="150em">
  <div class="media-body">
    <h5 class="mt-0">Combos para parejas</h5>
    Pizza de tamaño mediano, del sabor que prefiera el cliente. Se incluye dos gaseosas de tamaño personal del sabor de preferencia del cliente.
  </div>

  <?php
          if(isset($_SESSION['user'])){
            echo "<a href='infocombo2.php' class='btn btn-warning'>";
            echo "<svg width='2em' height='2em' viewBox='0 0 16 16' class='bi bi-arrow-right-square' fill='currentColor' xmlns='http://www.w3.org/2000/svg'>
              <path fill-rule='evenodd' d='M14 1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z'/>
              <path fill-rule='evenodd' d='M4 8a.5.5 0 0 0 .5.5h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H4.5A.5.5 0 0 0 4 8z'/>
              </svg>";
  ...
  <path fill-rule="evenodd" d="M4 8a.5.5 0 0 0 .5.5h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H4.5A.5.5 0 0 0 4 8z"/>
    ...
    <th>
      	<div class="media text-dark">
  <img src="https://i.ibb.co/7Q3WMV3/1.png" class="mr-3" alt="..." width="250em" height="150em">
  <div class="media-body">
    <h5 class="mt-0">Combo familiar</h5>
    Pizza de tamaño grande, del sabor que prefiera el cliente. Se incluye gaseosa de 3L del sabor de preferencia del cliente.
  </div>

  <?php
          if(isset($_SESSION['user'])){
            echo "<a href='infocombo3.php' class='btn btn-danger'>";
            echo "<svg width='2em' height='2em' viewBox='0 0 16 16' class='bi bi-arrow-right-square' fill='currentColor' xmlns='http://www.w3.org/2000/svg'>
              <path fill-rule='evenodd' d='M14 1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z'/>
              <path fill-rule='evenodd' d='M4 8a.5.5 0 0 0 .5.5h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H4.5A.5.5 0 0 0 4 8z'/>
              </svg>";
