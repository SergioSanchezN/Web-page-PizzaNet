...
<html lang="en">
 ...
 <div class="container">
  ...
  <img src="https://i.ibb.co/PMNDwt0/combopersonal.png" class="rounded mx-auto d-block img-fluid" width="50%" height="50%">
  <h1 class="h3 mb-3 font-weight-normal text-center">Combo personal</h1>

  <h5 >Pizza de tamaño personal, del sabor que prefiera el cliente. Se incluye gaseosa de tamaño personal del sabor de preferencia del cliente.</h5>
