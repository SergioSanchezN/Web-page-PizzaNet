...
<html lang="en">
 ...
 <div class="sticky-top">
  ...
  <img src="https://i.ibb.co/yBwqHVG/tropical.jpg" class="rounded mx-auto d-block img-fluid" width="50%" height="50%">
  <h1 class="h3 mb-3 font-weight-normal text-center"><?php echo $nombre; ?></h1>

  <h5 ><?php echo "Pizza con ". $tipomasa. " de tamaño ". $tamaño.  " con ". $numporciones. " porciones y con una base de " .$basepizza. "."; ?></h5>

  <div class="p-1 bg-white">  
</div>
<div class="p-3 mb-2 bg-danger">
</div>
<h5 class="text-center col-md-12">¿Deseas acompañar tu pizza con alguna bebida?</h5>
...
<button type="submit" href="factura.php" class="btn btn-danger">
  ...
  <a style="margin-left: 1%;" href="menu.php" class="btn btn-danger">
