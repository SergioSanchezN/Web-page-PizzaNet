...
<html lang="en">
 ...
 <div class="container">
  ...
  <h1 class="h3 mb-3 font-weight-normal text-center">Combos para parejas</h1>

  <h5 >Pizza de tamaño mediano, del sabor que prefiera el cliente. Se incluye dos gaseosas de tamaño personal del sabor de preferencia del cliente.</h5>
